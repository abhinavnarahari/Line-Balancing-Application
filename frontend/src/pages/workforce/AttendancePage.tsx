...
import { shiftAssignmentApi } from "../../features/shift-assignments/api";
...
const getStatusConfig = (status?: AttendanceStatus) => {
  switch (status) {
    ...
    default: return { bg: "bg-white", border: "border-[#F0EAE0]", text: "text-[#475569]", icon: AlertTriangle };
  }
};
    ...
    <div className="space-y-6 w-full p-6 lg:p-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
        <div className="bg-white border border-[#F0EAE0] rounded-sm p-4 flex flex-col justify-center items-center shadow-sm">
          ...
          <span className="text-2xl font-bold text-[#221912]">{roster.length}</span>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
            <div>
              ...
              <input
                ...
                className="h-10 bg-white border border-[#E6DDCE] rounded-sm px-3 text-sm text-[#221912] focus:outline-none focus:border-[#B48259] focus:ring-1 focus:ring-[#B48259]/20 w-full md:w-40"
              />
            </div>
            <div>
              ...
              <select
                ...
                className="h-10 bg-white border border-[#E6DDCE] rounded-sm px-3 text-sm text-[#221912] focus:outline-none focus:border-[#B48259] focus:ring-1 focus:ring-[#B48259]/20 w-full md:w-48"
              >
                {shifts.map(sh => (
            ...
            <div>
              <label className="text-[10.5px] font-semibold tracking-[0.1em] uppercase text-[#475569] block mb-1.5">Filter</label>
              <div className="relative">
                <Filter className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#8C7E6E]" />
                <select
                  value={statusFilter}
                  onChange={(e) => setStatusFilter(e.target.value as any)}
                  className="h-10 bg-white border border-[#E6DDCE] rounded-sm pl-9 pr-3 text-sm text-[#221912] focus:outline-none focus:border-[#B48259] focus:ring-1 focus:ring-[#B48259]/20 w-full md:w-40 appearance-none"
                >
              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    ...
                    config.bg,
                    isUnsaved ? "border-dashed border-2 border-[#B48259]" : config.border
                  )}
                >
                  {isUnsaved && (
                    <div className="absolute -top-2 -right-2 w-3 h-3 bg-[#B48259] rounded-full animate-pulse" />
                  )}
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-mono text-xs font-semibold text-[#8C7E6E] mb-0.5">{operator.employeeId}</p>
                      <h4 className="font-semibold text-[#221912] truncate text-sm">{operator.name}</h4>
                      <p className="text-xs text-[#475569] mt-0.5 truncate">{operator.department}</p>
                    </div>
                    {status && (
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        status === "PRESENT" 
                          ...
                          : "bg-white border-[#E6DDCE] text-[#221912] hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700"
                      )}
                    >
                      Present
                    </button>
                    <button
                      ...
                      className={cn(
                        ...
                        status === "LATE" 
                          ...
                          : "bg-white border-[#E6DDCE] text-[#221912] hover:bg-amber-50 hover:border-amber-200 hover:text-amber-700"
                      )}
                    >
                      Late
                    </button>
                    <button
                      ...
                      className={cn(
                        ...
                        status === "ABSENT" 
                          ...
                          : "bg-white border-[#E6DDCE] text-[#221912] hover:bg-red-50 hover:border-red-200 hover:text-red-700"
                      )}
                    >
                      Absent
                    </button>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        status === "HALF_DAY" 
                          ...
                          : "bg-white border-[#F0EAE0] text-[#475569] hover:bg-orange-50 hover:text-orange-700 hover:border-orange-200"
                      )}
                    >
                      Half Day
                    </button>
                    <button
                      ...
                      className={cn(
                        ...
                        status === "ON_LEAVE" 
                          ...
                          : "bg-white border-[#F0EAE0] text-[#475569] hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200"
                      )}
                    >
                      On Leave
                    </button>
